...
#include "DRV260x.h" // register stuff
#include "DRV2605.h" // the main header file
#include "app_error.h"
#include "nrf_delay.h"
...
//define the actuator, this might need some tunning, but not tuna
#define LRA_AUTOCAL_COMP        0x09                    // Compensation Coef.
#define LRA_AUTOCAL_BEMF        0x79                    // BEMF Coef.
#define LRA_AUTOCAL_FB          0xB6 //was b6                    // Feedback Control
...
#define LRA_CTRL3               LRADriveMode_once | LRA_ClosedLoop     
#define AUTOCALRESULTS_LRA 1
